        ...
        sections: [
          {
            ...
            name: 'Clothing',
            items: [
              { name: 'Tops', href: 'noitem' },
              { name: 'Dresses',href: 'noitem' },
              { name: 'Pants',href: 'noitem' },
              { name: 'Denim',href: 'noitem' },
              { name: 'Sweaters',href: 'noitem' },
              { name: 'T-Shirts',href: 'noitem' },
              { name: 'Jackets',href: 'noitem' },
              { name: 'Activewear',href: 'noitem' },
              { name: 'Browse All',href: 'noitem' },
            ],
          },
          {
            id: 'accessories',
            name: 'Accessories',
            items: [
              { name: 'Watches',href: 'noitem' },
              { name: 'Wallets',href: 'noitem' },
              { name: 'Bags',href: 'noitem' },
              { name: 'Sunglasses',href: 'noitem' },
              { name: 'Hats',href: 'noitem' },
              { name: 'Belts',href: 'noitem' },
            ],
          },
          {
            id: 'brands',
            name: 'Brands',
            items: [
              { name: 'Full Nelson',href: 'noitem' },
              { name: 'My Way',href: 'noitem' },
              { name: 'Re-Arranged',href: 'noitem' },
              { name: 'Counterfeit',href: 'noitem' },
              { name: 'Significant Other',href: 'noitem' },
            ],
          },
        ],
      },
