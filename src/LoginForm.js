                                    ...
                                    !isLogIn ? <Dialog.Panel className="flex transform text-left text-base transition w-80">
                                        <div className="relative flex items-center overflow-hidden bg-white px-4 pb-8 pt-14 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                                            ...
                                            <div class="border-gray-900/10">
                                                <h2 class="text-base font-semibold leading-7 text-gray-900">Looks like you're new here!</h2>
                                                <p class="mt-1 text-sm leading-6 text-gray-600">Sign up with your mobile number to get started</p>
                                                ...
                                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                                    ...
                                                    <div class="w-64">
                                                        ...
                                                        <div class="mt-2">
                                                            <input id="number" name="number" type="number" autocomplete="email" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <button
                                        ...
                                        <div className="relative flex items-center overflow-hidden bg-white px-4 pb-8 pt-14 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                                            ...
                                            <div class="border-gray-900/10">
                                                ...
                                                <p class="mt-1 text-sm leading-6 text-gray-600">Sign in with your mobile number to get started</p>
